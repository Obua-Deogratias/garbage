...
<body>
 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row">
                 <td class="menu-btn ">
                     <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">My Schedules</p></a></div>
                 </td>
             </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,station.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join station on schedule.docid=station.docid where station.docid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
