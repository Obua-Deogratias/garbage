 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-station">
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search station name or Email or Date (YYYY-MM-DD)" list="stations" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join station on schedule.docid=station.docid where schedule.scheduleid=$id  order by schedule.scheduledate desc";
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            station name:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            station Email:  &nbsp;&nbsp;<b>'.$docemail.'</b>
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Channeling fee : Avg.<b>UGX. 7,500 - 10,000</b>
